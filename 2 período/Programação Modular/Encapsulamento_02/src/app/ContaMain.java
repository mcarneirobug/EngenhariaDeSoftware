...
public class ContaMain {
	...
	public static void main(String[] args) {
		...
		if(conta.sacar(sc.nextDouble())) {
			System.out.println("Saldo atualizado: " + conta.getSaldo() + ", conta: "+ conta.getConta() + ", id: "+ Conta.getId() + ".");
		} else {
			System.out.println("Voce nao tem saldo suficiente para sacar, saldo atual: " + conta.getSaldo() + ", id: "+ Conta.getId()+ ".");
		} //end else
